                ...
                <div class="x_title">
                    <h2>Administrador de permisos</h2>
                      <ul class="nav navbar-right panel_toolbox">
                          <li>
                              <button type="button" class="btn btn-success" onclick="window.location='{{ route('admin::permissions.create') }}';">Nuevo</button>
                          </li>
                      </ul>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>{{ $item->name }}</td>
                              <td>
                                <a href="{{ route('admin::permissions.edit', ['permissions' => $item->id, 'page' => $page]) }}" data-toggle="tooltip" data-placement="top" title="Editar" class="status-icons"><i class="fa fa-pencil-square-o fa-lg"></i></a>
